...
<div id="mySidenav" class="sidenav">
            ...
            if(isset($_SESSION['name']) && isset($_SESSION['key']) && $_SESSION['key']==='1234')
            {
                ?>
                <a href="../home.php"><i class="fa fa-home"></i>&nbsp;Home</a>
                <a href="view_visiter_details.php"><i class="fa fa-eye"></i>&nbsp;View Visiter Details</a>
                <a href="view_feedbacks.php"><i class="fa fa-eye"></i>&nbsp;View Feedbacks</a>
                <a href="general_rating.php"><i class="fa fa-eye"></i>&nbsp;General Feedbacks</a>

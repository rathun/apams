...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="search" id="search" class="form-fields" placeholder="Search By Date" style="border:2px solid #16336d" />
  ...
  <?php
    include '../db.php';
  $name=$_SESSION['name'];
  $sql="SELECT * FROM assign_task INNER JOIN user ON assign_task.visiting_officer=user.username WHERE assign_task.status='Visited' AND assign_task.institution='$name' AND assign_task.feedback='1' ORDER BY date";

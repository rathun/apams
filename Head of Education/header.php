...
<div id="mySidenav" class="sidenav">
            ...
            if(isset($_SESSION['name']) && isset($_SESSION['key']) && $_SESSION['key']==='123')
            {
                ...
                <a href="assign_task_form.php"><i class="fa fa-plus"></i>&nbsp;Assign Task</a>
                ...
                <a href="add_criteria_form.php"><i class="fa fa-plus"></i>&nbsp;Add Criteria Questionnaries</a>
                <a href="update_criteria_form.php"><i class="fa fa-plus"></i>&nbsp;Modify Criteria Questionnaries</a>
                <a href="add_institution.php"><i class="fa fa-plus"></i>&nbsp;Add Institution</a>
                <a href="create_new_user.php"><i class="fa fa-plus"></i>&nbsp;Create New Users</a>
                <a href="user_management.php"><i class="fa fa-plus"></i>&nbsp;User Management</a>
      ...
      <div class="modal-body">
        <form id="change_password_form">
          <div class="form-group">
            ...
            <input type="text" name="email" class="form-control1" value="<?php if(isset($_SESSION['mail'])) echo $_SESSION['mail']; ?>" placeholder="Username" readonly>
